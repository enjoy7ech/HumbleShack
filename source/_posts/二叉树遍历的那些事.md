...
![插入7的时候，叶子节点变为567，进行分裂，中位数6变成新的父节点插入原父节点24，原父节点变成246再进行分裂，中位数4变成新的父节点](https://pan.dongzx.lol/api/v3/file/get/7900/B_tree_insertion_example.png?sign=grvKUCrVyx8IBlBV5TbMIQNywdMMABTFqGg7w9RHKug%3D%3A0)
